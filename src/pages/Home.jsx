  ...
  const POSTS = [
    {
      ...
      excerpt:
        "How large language models are reshaping the way engineers write, review, and ship production code at scale across distributed teams.",
      category: "Technology",
      author: "Aria Chen",
      initials: "AC",
      date: "Jun 28, 2026",
      readTime: "6 min",
      imageId: "photo-1677442135703-1787eea5ce01",
      views: 14200,
      likes: 892,
      tags: ["AI", "Engineering"],
      featured: true,
          ...
          <div className="lg:col-span-3">
            ...
            >
              <div className="relative h-72 overflow-hidden bg-slate-800">
                <img
                  src={`https://images.unsplash.com/${featured.imageId}?w=1200&h=600&fit=crop&auto=format`}
                  alt={featured.title}
              ...
              <div className="px-6 py-4 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Avatar initials={featured.initials} size="sm" />
                ...
                {POSTS.slice(3).map((post) => (
                  ...
                  >
                    <div className="w-20 h-16 rounded-lg overflow-hidden bg-slate-800 shrink-0">
                      <img
                        src={`https://images.unsplash.com/${post.imageId}?w=160&h=120&fit=crop&auto=format`}
                        alt={post.title}
          ...
          <aside className="space-y-5">
            ...
            >
              ...
              <div className="space-y-1">
                {[
                  { label: "Technology", count: 24, dot: "#3B82F6" },
                ...
                {POSTS.slice(0, 3).map((post) => (
                  <div
                    ...
                    <div className="w-12 h-12 rounded-lg overflow-hidden bg-slate-800 shrink-0">
                      <img
                        src={`https://images.unsplash.com/${post.imageId}?w=96&h=96&fit=crop&auto=format`}
                        alt={post.title}
                        className="w-full h-full object-cover"
                      />
                    </div>
